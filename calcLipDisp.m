%% Obtain deltaP
a1 = 2 / k + omega0(n)^2 * k + sig + g^2 * k / (2 * Mlip);
a2 = Sr / Mlip;
a3 = 2/k * 1/k * (y - yPrev) - omega0(n)^2 * yPrev + g / Mlip * psiPrev;
...
%% Update lip scheme
gammaR = g * k^2 / (2 * Mlip);
alpha = 2 + omega0(n)^2 * k^2 + sig * k + g * gammaR;
beta = sig * k - 2 - omega0(n)^2 * k^2 + g * gammaR;
xi = 2 * Sr * k^2 / Mlip;
